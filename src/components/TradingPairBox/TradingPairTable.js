  ...
  render() {
    return (
      <View style={ styles.container }>
        <TradingPairTableHeader columStyles={ this.dynamicColumnStyles }></TradingPairTableHeader>
        <TradingPairTableBody columStyles={ this.dynamicColumnStyles } ></TradingPairTableBody>
      </View>
    );
  }
}
